#
#  Be sure to run `pod spec lint CalculationLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Michitaka Ishida" => "ishida@jambo-inc.io" }
  # Or just: spec.author    = "Mitti09"
  # spec.authors            = { "Mitti09" => "develop.application01@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Mitti09"
